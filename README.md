...
# 📖 Fast React Pizza App <a name="about-project"></a>

**[Fast React Pizza App]** is an application which uses all of reactr cool features such as react router, fast-react-pizza, fast-react-pizza toolkit, contextApi etc.
...
```sh
  cd my-folder
  git clone https://github.com/Efiamotu-1/fast-react-pizza.git
```
...
Feel free to check the [issues page](https://github.com/Efiamotu-1/fast-react-pizza/issues).
